        ...
        const fetchBalances = async () => {
            try {
                ...
                for(const asset in assetResponse){
                    ...
                    const imageUrl = assetData.has_ipfs && assetData.ipfs_hash ? `https://rose-decent-prawn-420.mypinata.cloud/ipfs/${assetData.ipfs_hash}?pinataGatewayToken=HtcAOAK7UkS5a7JrD-_1j4FwStTV2Qw4uNJ7_Esk-TvoCsn87T6wUeoq6w7WN3SO` : logo;
