...
import {evrmoreService} from '@/Application/services/EvrmoreService';
...
//  }, [isConnected]);
  ...
  const fetchAssets = async () => {
    ...
    try {
      ...
      console.log(sanitizedAssetName);
      const response = await evrmoreService.getAssetInfo(sanitizedAssetName);
