        ...
        <div className='page-container'>
            ...
            <div className='container'>
                ...
                <div id="overview">
                    ...
                    <ReactTooltip id="utxo-tooltip" place="top" effect="solid" className="react-tooltip" />
                </div>
                ...
                <div id="features">
                    ...
                    <ReactTooltip id="pow-tooltip" place="top" effect="solid" className="react-tooltip" />
                    <ReactTooltip id="zero-tooltip" place="top" effect="solid" className="react-tooltip" />
                </div>
                <div className='divider'></div>
